    ...
    <div class="mx-auto max-w-3xl sm:px-6 lg:px-8">
        <flux:card>
            ...
            <form wire:submit="save" class="space-y-6">
                ...
                <flux:input wire:model="title" label="{{ __('Judul Pengaduan') }}" placeholder="e.g. Jalan rusak di RT 03" required />
                
                <flux:textarea wire:model="description" label="{{ __('Deskripsi Detail') }}" placeholder="{{ __('Jelaskan dengan detail lokasi, waktu, dan kejadian...') }}" rows="6" required />
