        ...
        <flux:card>
            ...
            <form wire:submit="save" class="space-y-6">
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <flux:input wire:model="jabatan" label="{{ __('Jabatan') }}" placeholder="e.g. Kepala Desa, Bendahara" required />
                    <flux:input wire:model="nip" label="{{ __('NIP / NIK') }}" placeholder="Nomor Induk Pegawai (opsional)" />
                </div>
